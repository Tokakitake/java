...
public class ScreenPanel extends JPanel implements ActionListener {
    ...
    private void loadIcons() {
        ...
        ImageIcon iisnakepart = new ImageIcon("src/main/java/main/snakepart.png");
        snakepart = iisnakepart.getImage();

        ImageIcon iiapple = new ImageIcon("src/main/java/main/apple.png");
        apple = iiapple.getImage();

        ImageIcon iisnakehead = new ImageIcon("src/main/java/main/snakehead.png");
